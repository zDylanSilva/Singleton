...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Another attempt of instance to check the logic flow still works since its the same object
		Boiler anotherBoiler = Boiler.getInstance();
		...
		System.out.println(anotherBoiler.emptyContainer());
		
		//Failure test
		
		System.out.println("\nThe message below should send an error since it skips the ingredient method");
		System.out.println(anotherBoiler.startMixing());
